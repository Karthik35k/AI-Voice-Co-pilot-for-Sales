...
export const VoiceSelector: React.FC<VoiceSelectorProps> = ({
  ...
  return (
    <div className="bg-fintech-card/60 border border-fintech-border rounded-xl p-4 flex flex-col gap-4 text-xs w-full max-w-3xl">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between w-full">
        <div className="flex items-center gap-2 min-w-0 w-full sm:w-auto">
          ...
          <select
            ...
            className="bg-slate-900 border border-fintech-border text-slate-200 rounded-lg px-2.5 py-1.5 focus:outline-none focus:border-cyan-500 w-full sm:w-70 truncate"
          >
            {voices.length === 0 ? (
